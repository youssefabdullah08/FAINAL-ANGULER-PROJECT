...
eToken:any= localStorage.getItem('token') 
  ...
  addProduct(ID:any) :Observable <any>{
   ...
   return this._cartApi.post(`https://ecommerce.routemisr.com/api/v1/cart`,{
      productId:ID
    },
    {
      headers:{
  ...
  REMOVECartPrud(id:any):Observable<any>{
    return this._cartApi.delete(`https://ecommerce.routemisr.com/api/v1/cart/${id}`,
    {
      headers:{
        token:this.eToken
      }
  ...
  changeCount(id:string, count:number):Observable<any>{
    return this._cartApi.put(`https://ecommerce.routemisr.com/api/v1/cart/${id}`,{count},
    {
      headers:{
        token:this.eToken
      }
...
return this._cartApi.post(`https://ecommerce.routemisr.com/api/v1/wishlist`,{
  productId:id
},
{
  ...
  getWishlist():Observable<any>{
    return this._cartApi.get(`https://ecommerce.routemisr.com/api/v1/wishlist`,
