...
constructor(private _brandinfo:BlankapiService, private _active:ActivatedRoute,private _add:CartService,private toastr: ToastrService){}
ngOnInit(){
  this.getId()
  this.getInfoData()
...
getBrandProducts(){
  this._brandinfo.mainProducts().subscribe({
    next:(res)=>{
