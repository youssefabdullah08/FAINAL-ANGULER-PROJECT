...
constructor(private _cateApi:BlankapiService,private _pramID:ActivatedRoute,private toastr: ToastrService,private _add:CartService){}
ngOnInit(){
  this.GETid()
  this.getScate()
  this.getProducts()
...
getProducts(){
  this._cateApi.mainProducts().subscribe({
    next:(res)=>{
